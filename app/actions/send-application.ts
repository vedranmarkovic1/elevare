      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(135deg, #0a0f1c 0%, #1a1f2e 100%); padding: 30px; border-radius: 10px 10px 0 0;">
            ...
            <p style="color: #94a3b8; margin: 10px 0 0 0;">Nova prijava za upis</p>
          </div>
          
          <div style="background: #f8fafc; padding: 30px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 10px 10px;">
            <h2 style="color: #1e293b; margin-top: 0;">Podaci o osobi</h2>
            
            <div style="background: white; padding: 20px; border-radius: 8px; border: 1px solid #e2e8f0; margin-bottom: 20px;">
              <p style="margin: 0 0 10px 0;"><strong style="color: #64748b;">Ime i prezime:</strong></p>
              <p style="margin: 0 0 20px 0; color: #1e293b; font-size: 16px;">${name}</p>
              
              <p style="margin: 0 0 10px 0;"><strong style="color: #64748b;">Email adresa:</strong></p>
              <p style="margin: 0 0 20px 0; color: #1e293b; font-size: 16px;">
                <a href="mailto:${email}" style="color: #c9a227;">${email}</a>
              </p>
              
              <p style="margin: 0 0 10px 0;"><strong style="color: #64748b;">Poruka:</strong></p>
              <p style="margin: 0; color: #1e293b; font-size: 16px; white-space: pre-wrap;">${message}</p>
            </div>
            
            <p style="color: #64748b; font-size: 14px; margin: 0;">
              Ova poruka je poslata putem kontakt forme na sajtu Elevare Academy.
            </p>
          </div>
        </div>
      `,
